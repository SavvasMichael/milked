...
public class ShaftControllerIntegrationTest {
    ...
    public void createShaftReturns201ResponseCode() {
        ...
        //when
        ShaftRequest shaftRequest = new ShaftRequest(1L, 2L, 5L,1);
    ...
    public void createShaftReturnsCorrectBodyFieldElements() {
        ...
        ShaftRequest shaftRequest = new ShaftRequest(userTwoResponse.getBody().getId(), userResponse.getBody().getId(), groupResponse.getBody().getId(), 100);
        ...
        assertEquals(100, (int)shaftResponse.getBody().getAmount());
    }
}